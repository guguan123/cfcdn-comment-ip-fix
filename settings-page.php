...
<div class="wrap">
	<h1><?php esc_html_e('Correct Commenter IP', 'cfcdn-comment-ip-fix'); ?></h1>
	<p><?php esc_html_e('This is the management page for the Commenter IP Fix plugin.', 'cfcdn-comment-ip-fix'); ?></p>
	...
	<form method="post" id="cfcdnipfix-update-other-ips-form">
		<?php settings_fields('cfcdnipfix_settings'); // 添加 nonce 等字段 ?>
		<h2><?php esc_html_e('Additional CDN IPs', 'cfcdn-comment-ip-fix'); ?></h2>
		<p><?php esc_html_e('Enter additional CDN IP addresses (separate multiple addresses with commas):', 'cfcdn-comment-ip-fix'); ?></p>
	...
	<hr />
	<h2><?php esc_html_e('Current Stored IP Information', 'cfcdn-comment-ip-fix'); ?></h2>
	<pre>
